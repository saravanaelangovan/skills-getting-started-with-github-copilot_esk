...
activities = {
    ...
    "Volleyball Club": {
        "description": "Recreational and competitive volleyball activities",
        "schedule": "Tuesdays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["rachel@mergington.edu", "jessica@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["charles@mergington.edu", "zoe@mergington.edu"]
    }
}
